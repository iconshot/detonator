...
class Renderer {
    ...
    init(_ detonator: Detonator, _ rootView: ViewLayout) {
        ...
        detonator.addMessageHandler(key: "com.iconshot.detonator.renderer/treeInit") { dataString in
            let data: TreeInitData = detonator.decode(dataString)!
        ...
        detonator.addMessageHandler(key: "com.iconshot.detonator.renderer/treeDeinit") { dataString in
            let data: TreeDeinitData = detonator.decode(dataString)!
            
            self.trees[data.treeId] = nil
        }
        
        detonator.addMessageHandler(key: "com.iconshot.detonator.renderer/mount") { dataString in
            let data: MountData = detonator.decode(dataString)!
        ...
        detonator.addMessageHandler(key: "com.iconshot.detonator.renderer/unmount") { dataString in
            let data: UnmountData = detonator.decode(dataString)!
        ...
        detonator.addMessageHandler(key: "com.iconshot.detonator.renderer/rerender") { dataString in
            let data: RerenderData = detonator.decode(dataString)!
    ...
    private func createElement(edge: Edge) -> Element? {
        ...
        guard let elementClass = detonator.getElementClass(key: contentType) else {
            return nil
        }
