...
public class FullScreenModule extends Module {
    ...
    public void register() {
        detonator.addRequestClass("com.iconshot.detonator.fullscreen/open", FullScreenOpenRequest.class);
        detonator.addRequestClass("com.iconshot.detonator.fullscreen/close", FullScreenCloseRequest.class);
    }
