...
public class Renderer {
    ...
    public Renderer(Detonator detonator, ViewLayout rootView) {
        ...
        detonator.addMessageHandler("com.iconshot.detonator.renderer/treeInit", dataString -> {
            TreeInitData data = detonator.decode(dataString, TreeInitData.class);
        ...
        detonator.addMessageHandler("com.iconshot.detonator.renderer/treeDeinit", dataString -> {
            TreeDeinitData data = detonator.decode(dataString, TreeDeinitData.class);

            trees.remove(data.treeId);
        });

        detonator.addMessageHandler("com.iconshot.detonator.renderer/mount", dataString -> {
            MountData data = detonator.decode(dataString, MountData.class);
        ...
        detonator.addMessageHandler("com.iconshot.detonator.renderer/unmount", dataString -> {
            UnmountData data = detonator.decode(dataString, UnmountData.class);
        ...
        detonator.addMessageHandler("com.iconshot.detonator.renderer/rerender", dataString -> {
            RerenderData data = detonator.decode(dataString, RerenderData.class);
